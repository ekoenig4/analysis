...
def jets_study(selection,plot=True,saveas=None,density=0,log=0,**kwargs):
    study = Study(selection,saveas=saveas,**kwargs)     
    selection = study.selection     
    branches = selection.branches     
    subset = study.subset
...
def jets_2d_study(selection,plot=True,saveas=None,density=0,log=0,**kwargs):
    study = Study(selection,saveas=saveas,**kwargs)     
    selection = study.selection     
    branches = selection.branches     
    subset = study.subset
...
def ijets_study(selection,plot=True,saveas=None,njets=-1,show_ijet=None,topbkg=False,density=0,log=0,**kwargs):
    study = Study(selection,saveas=saveas,**kwargs)     
    selection = study.selection     
    branches = selection.branches     
    subset = study.subset
...
def jets_2d_ordered_study(selection,plot=True,saveas=None,njets=6,topbkg=True,compare=False,density=0,log=0,**kwargs):
    study = Study(selection,saveas=saveas,**kwargs)     
    selection = study.selection     
    branches = selection.branches     
    subset = study.subset
...
def x_reco_study(selection,plot=True,saveas=None,**kwargs):
    study = Study(selection,saveas=saveas,**kwargs)     
    selection = study.selection     
    branches = selection.branches     
    subset = study.subset
...
def njet_study(selection,plot=True,saveas=None,density=0,**kwargs):
    ...
    hist_multi([njets],bins=range(16),xlabel=f"Number of Jets {subset.capitalize()}",labels=["All Events"],density=density,figax=(fig,axs[0]))
    hist_multi([nsixb],bins=range(8),xlabel=f"Number of Signal Jets {subset.capitalize()}",labels=["All Events"],density=density,figax=(fig,axs[1]))
