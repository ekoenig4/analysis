...
class Feynman:
    ...
    def _reco_id(feynman):
        ...
        return hash(str(reduce(lambda h1,h2 : h1&h2, hashes)))
    ...
    def get_finalstate_permutations(self, **nfinalstates):
        ...
        for permutations in it.product(*finalstate_type_permutations.values()):
            permutations = {
            ...
            reco_id = self.get_reco_id(**permutations)
